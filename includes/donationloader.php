...
class JQueryTinytipsDonationLoader {
  var $donationLoaderUserAgent =  JQUERYTINYTIPS_USERAGENT;
  var $donationLoaderPluginName = JQUERYTINYTIPS_PLUGIN_NAME;
  var $donationLoaderPluginUrl = JQUERYTINYTIPS_PLUGIN_URL;
   ...
   * @return void
   */
  function JQueryTinytipsDonationLoader() {
